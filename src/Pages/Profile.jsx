...
const Profile = () => {
  ...
  return (
    <>
      <hr />
      <div className="profileBackground p-6">
        <button
          type="submit"
          className="submit-button bg-transparent text-black border border-black rounded-full px-8 py-2 me-[300px] mt-2 mx-auto block text-2xl subHeading transition-transform duration-300 ease-in-out transform hover:scale-110 active:scale-95"
          style={{
            boxShadow:
        ...
        <div className="flex ml-40 mt-15 p-10">
          <div className=" p-4">
            <ul className="space-y-10">
              ...
              >
                <UsernameIcon />
                <span className="section profileHeading">Mythica</span>
              </li>
              <li
                className="menu-item cursor-pointer flex items-center space-x-2 "
              ...
              >
                <BookmarkIcon />
                <span className="profileSubHeading">Bookmarks</span>
              </li>
              <li
                className="menu-item cursor-pointer flex items-center space-x-2 "
              ...
              >
                <DraftsIcon />
                <span className="profileSubHeading">Drafts</span>
              </li>
              <li
                className="menu-item cursor-pointer flex items-center space-x-2 "
              ...
              >
                <FavoriteIcon />
                <span className="profileSubHeading">Favorites</span>
              </li>
              <li
                className="menu-item cursor-pointer flex items-center space-x-2 "
              ...
              >
                <SavedIcon />
                <span className="profileSubHeading">Saved</span>
              </li>
            </ul>
          </div>
